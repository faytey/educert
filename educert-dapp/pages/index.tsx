    ...
    <Layout status={true} clicked="" secondClick="">
      <div className="relative">
        ...
        <div className=" xxl:hidden sm:w-[330px] sm:mx-[20px] sm:text-center xl:hidden">
          <h1 className="sm:text-[30px] sm:font-[900] satoshi sm:w-[330px] text-[#EEEEF0]">
            Verify <span className="text-[#B21888]">Certifications</span> in
            seconds
          </h1>
          <p className="sm:w-[330px] sm:font-[400] satoshi text-[#EEEEF0]">
            Decentralized and secure solution for issuing verifiable
            certificates to learners and professionals.
          </p>
        </div>
        <div className="xxl:hidden xl:hidden moving-div satoshi sm:mt-[20px]">
          For full functionality, please use a desktop browser with Metamask
          installed
        </div>
        ...
        <div className="sm:hidden absolute top-[10%]">
          <Box
            ...
            style={{
              ...
              boxShadow: "0px 0px 60px 0px #EC27B699",
            }}
            borderRadius="50%"
