        ...
        <div>
          <div className="w-[1114px] h-[38px] rounded-[10px] bg-[#FFFEFF70] mx-auto flex justify-between px-[100px] py-[5px]">
            <div className="flex space-x-2">
              <h1 className="text-[16px] font-[500] satoshi w-[167px] text-[#FFFFFF]">
                Institution Name
              </h1>
              <p className="text-[16px] font-[400] satoshi w-[167px] text-[#FFFFFF9E]">
                {childContractData?._name}
              </p>
            </div>
            <div className="flex space-x-2">
              <h1 className="text-[16px] font-[500] satoshi w-[167px] text-[#FFFFFF]">
              ...
              <p className="text-[16px] font-[400] satoshi w-[150px] text-[#FFFFFF9E]">
                {Number(childContractData?.certMinted)}
              </p>
            </div>
          </div>
          <div className="w-[1109px] h-[520px] rounded-[14px] bg-[#FFFFFF] mx-auto mt-[20px] px-[30px] py-[30px] relative">
            <div className="flex justify-between">
              <div
                className="text-[18px] text-center text-[#717171] font-[400] w-[518px]"
                style={{ borderBottom: isSign ? "6px solid #4C32C3" : "none" }}
              >
                Sign Certificate
              </div>
              <div
                className="text-[18px] text-center text-[#717171] font-[400] w-[518px]"
                style={{ borderBottom: isMint ? "6px solid #4C32C3" : "none" }}
              >
                Mint Certificate
              </div>
            </div>
            ...
            />
            {isSign && (
              <div className="space-y-6 mt-[70px] w-[1050px] text-center">
                <Input
                  type="text"
                  id="walletInput"
                  ...
                  className="bg-[#D4D4D43B] satoshi mx-auto  text-[18px] xl:text-[14px] text-black px-[20px]"
                  value={walletAddress}
                ...
                <Input
                  type="number"
                  id="expiry"
                  placeholder="Expiry period : 1722787680"
                  style={{
                    width: "724px",
                    height: "56px",
                    borderRadius: "12px",
                ...
                <div className="w-[1050px] flex justify-end px-[30px] mt-[150px]">
                  <Button
                    ...
                    className="xxl:w-[259px] xl:w-[200px] text-[18px] xxl:h-[39px] rounded-[8px]  px-[24px] py-[16px] xl:text-[14px]"
                    onClick={handleSign}
                  >
                    Sign
                  </Button>
            ...
            {isMint && (
              <div className="space-y-6 mt-[70px] w-[1050px] text-center">
                <div className="flex space-x-3 text-[#4C32C3] text-[14px] w-[724px] justify-start mt-[10px] mx-auto">
                  <AiOutlineInfoCircle className="w-[18px] h-[18px]" />
                  <p>
                    Please note: the wallet address and Expiry period
                    credentials must match the previous screen
                  </p>
                </div>
                <Input
                  type="text"
