            ...
            <div className="relative flex h-16 justify-between">
              ...
              <div className="flex flex-1 items-center sm:items-stretch sm:justify-start space-x-8 relative z-10">
                <div className="flex flex-shrink-0 items-center space-x-2">
                  <Image
                    className="block sm:block lg:block"
                    src={logo}
                    width="45"
                    alt="educert Logo"
                  />
                  <h1 className="text-[30px] font-[700] text-[#FFFFFF] satoshi">
                    Edu<span className="text-[#EC27B6]">Cert</span>
                  </h1>
                </div>
                {!prop.status && (
                  <Link href="/">
                    <h1 className="text-[#FFFFFF] satoshi">Home</h1>
                  </Link>
                )}
              </div>
                ...
                {prop.status && (
                  <>
                    <Link href={isExist ? "/dashboard" : "#createAccount"}>
                      <h1 className="sm:hidden relative z-10 text-[14px] xxl:text-[18px] xxl:w-[350] font-[400] h-[20px] xl:w-[120px] text-[#EEEEF0] satoshi">
                        {isExist ? "Dashboard" : "Create Account"}
                      </h1>
                    </Link>
                    <Link href="#Aboutus">
                      <h1 className=" sm:hidden relative z-10 text-[14px] xxl:text-[18px] xxl:w-[350] font-[400] h-[20px] xl:w-[89px] text-[#EEEEF0] satoshi">
                        About Us
                      </h1>
                    </Link>
                  </>
              ...
              {popOpen && (
                <div className="w-[245px] h-[104px] bg-[#A9A9A970] rounded-[8px] border-[1px] mr-[150px] mt-[70px] text-center">
                  <h1
                    className="w-[167px] my-[20px] h-[22px] satoshi font-[400] text-[16px] text-[#EEEEF06B] border-b-[2px] mx-auto cursor-pointer"
                    onClick={handleownershipDialog}
                  >
                    Transfer Ownership
                  </h1>
                  <h1
